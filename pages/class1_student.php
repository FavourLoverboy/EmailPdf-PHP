...
<table class="table table-hover table-bordered table-striped">
        ...
        <tbody>
            <tr>
                <?php
                    $tblquery = "SELECT * FROM student WHERE class = 'Class 1' ORDER BY name";
                    $tblvalue = array();
                        ...
                        <?php
                            echo "
                                <tr>
                                    ...
                                    <td>$sex</td>
                                    <td>
                                        <form action='class1_student' method='POST'>
    ...
    <?php
        if($_POST['view']){
            ...
            echo '<script> window.location="http://localhost/emailpdf/result_class1"; </script>';
        }
    ?>