<?php 
    if($_POST['class3_test']){
        ...
        if($agric < 21){
            $tblquery = "UPDATE subject SET test = :agric WHERE subject = :sub AND stu_id = :stu";
            $tblvalue = array(
                ':agric' => htmlspecialchars($agric),
                ':sub' => 'Agriculture',
                ':stu' => $_SESSION['stu_id']
            );
            $update5 = $collect->tbl_update($tblquery, $tblvalue);
        }

        if($bio < 21){
            $tblquery = "UPDATE subject SET test = :bio WHERE subject = :sub AND stu_id = :stu";
            $tblvalue = array(
                ':bio' => htmlspecialchars($bio),
                ':sub' => 'Biology',
                ':stu' => $_SESSION['stu_id']
            );
            $update6 = $collect->tbl_update($tblquery, $tblvalue);
        }
    }
...
<?php 
    if($_POST['class3_ca']){
        ...
        if($agric < 21){
            $tblquery = "UPDATE subject SET ca = :agric WHERE subject = :sub AND stu_id = :stu";
            $tblvalue = array(
                ':agric' => htmlspecialchars($agric),
                ':sub' => 'Agriculture',
                ':stu' => $_SESSION['stu_id']
        ...
        if($bio < 21){
            $tblquery = "UPDATE subject SET ca = :bio WHERE subject = :sub AND stu_id = :stu";
            $tblvalue = array(
                ':bio' => htmlspecialchars($bio),
                ':sub' => 'Biology',
                ':stu' => $_SESSION['stu_id']
...
<?php 
    if($_POST['class3_exam']){
        ...
        if($agric < 61){
            $tblquery = "UPDATE subject SET exam = :agric WHERE subject = :sub AND stu_id = :stu";
            $tblvalue = array(
                ':agric' => htmlspecialchars($agric),
                ':sub' => 'Agriculture',
                ':stu' => $_SESSION['stu_id']
        ...
        if($bio < 61){
            $tblquery = "UPDATE subject SET exam = :bio WHERE subject = :sub AND stu_id = :stu";
            $tblvalue = array(
                ':bio' => htmlspecialchars($bio),
                ':sub' => 'Biology',
                ':stu' => $_SESSION['stu_id']
    ...
    if($update1 or $update2 or $update3 or $update4 or $update5 or $update6){
        ...
        $tblquery = "SELECT * FROM subject WHERE subject = 'Agriculture' AND stu_id = '$_SESSION[stu_id]'";
        $tblvalue = array();
        $select = $collect->tbl_select($tblquery, $tblvalue);
        foreach($select as $data){
            extract($data);
            $_SESSION['Agriculture_test'] = $test;
            $_SESSION['Agriculture_ca'] = $ca;
            $_SESSION['Agriculture_exam'] = $exam;

            $_SESSION['Agriculture_total'] = $_SESSION['Agriculture_test'] + $_SESSION['Agriculture_ca'] + $_SESSION['Agriculture_exam'];
            ?>
            <?php
        }
        ...
        $tblquery = "UPDATE subject SET total = :total WHERE subject = :sub AND stu_id = :stu";
        $tblvalue = array(
            ':total' => $_SESSION['Agriculture_total'],
            ':sub' => 'Agriculture',
            ':stu' => $_SESSION['stu_id']
        );
        $update = $collect->tbl_update($tblquery, $tblvalue);
        ...
        if($update){
            if($_SESSION['Agriculture_total'] > 89){
                $tblquery = "UPDATE subject SET grade = :grade WHERE subject = :sub AND stu_id = :stu";
                $tblvalue = array(
                    ':grade' => 'A',
                    ':sub' => 'Agriculture',
                ...
                $update = $collect->tbl_update($tblquery, $tblvalue);
            }else if($_SESSION['Agriculture_total'] > 79){
                $tblquery = "UPDATE subject SET grade = :grade WHERE subject = :sub AND stu_id = :stu";
                $tblvalue = array(
                    ':grade' => 'B',
                    ':sub' => 'Agriculture',
                ...
                $update = $collect->tbl_update($tblquery, $tblvalue);
            }else if($_SESSION['Agriculture_total'] > 69){
                $tblquery = "UPDATE subject SET grade = :grade WHERE subject = :sub AND stu_id = :stu";
                $tblvalue = array(
                    ':grade' => 'C',
                    ':sub' => 'Agriculture',
                ...
                $update = $collect->tbl_update($tblquery, $tblvalue);
            }else if($_SESSION['Agriculture_total'] > 59){
                $tblquery = "UPDATE subject SET grade = :grade WHERE subject = :sub AND stu_id = :stu";
                $tblvalue = array(
                    ':grade' => 'D',
                    ':sub' => 'Agriculture',
                ...
                $update = $collect->tbl_update($tblquery, $tblvalue);
            }else if($_SESSION['Agriculture_total'] > 49){
                $tblquery = "UPDATE subject SET grade = :grade WHERE subject = :sub AND stu_id = :stu";
                $tblvalue = array(
                    ':grade' => 'E',
                    ':sub' => 'Agriculture',
                ...
                $update = $collect->tbl_update($tblquery, $tblvalue);
            }else if($_SESSION['Agriculture_total'] < 50){
                $tblquery = "UPDATE subject SET grade = :grade WHERE subject = :sub AND stu_id = :stu";
                $tblvalue = array(
                    ':grade' => 'F',
                    ':sub' => 'Agriculture',
    ...
    if($update1 or $update2 or $update3 or $update4 or $update5 or $update6){
        ...
        $tblquery = "SELECT * FROM subject WHERE subject = 'Biology' AND stu_id = '$_SESSION[stu_id]'";
        $tblvalue = array();
        $select = $collect->tbl_select($tblquery, $tblvalue);
        foreach($select as $data){
            extract($data);
            $_SESSION['Biology_test'] = $test;
            $_SESSION['Biology_ca'] = $ca;
            $_SESSION['Biology_exam'] = $exam;

            $_SESSION['Biology_total'] = $_SESSION['Biology_test'] + $_SESSION['Biology_ca'] + $_SESSION['Biology_exam'];
            ?>
            <?php
        }
        ...
        if($update){
            if($_SESSION['Biology_total'] > 89){
                ...
                $update = $collect->tbl_update($tblquery, $tblvalue);
            }else if($_SESSION['Biology_total'] > 79){
                $tblquery = "UPDATE subject SET grade = :grade WHERE subject = :sub AND stu_id = :stu";
                $tblvalue = array(
                    ':grade' => 'B',
                    ':sub' => 'Biology',
                ...
                $update = $collect->tbl_update($tblquery, $tblvalue);
            }else if($_SESSION['Biology_total'] > 69){
                $tblquery = "UPDATE subject SET grade = :grade WHERE subject = :sub AND stu_id = :stu";
                $tblvalue = array(
                    ':grade' => 'C',
                    ':sub' => 'Biology',
                ...
                $update = $collect->tbl_update($tblquery, $tblvalue);
            }else if($_SESSION['Biology_total'] > 59){
                $tblquery = "UPDATE subject SET grade = :grade WHERE subject = :sub AND stu_id = :stu";
                $tblvalue = array(
                    ':grade' => 'D',
                    ':sub' => 'Biology',
                ...
                $update = $collect->tbl_update($tblquery, $tblvalue);
            }else if($_SESSION['Biology_total'] > 49){
                $tblquery = "UPDATE subject SET grade = :grade WHERE subject = :sub AND stu_id = :stu";
                $tblvalue = array(
                    ':grade' => 'E',
                    ':sub' => 'Biology',
                ...
                $update = $collect->tbl_update($tblquery, $tblvalue);
            }else if($_SESSION['Biology_total'] < 50){
                $tblquery = "UPDATE subject SET grade = :grade WHERE subject = :sub AND stu_id = :stu";
                $tblvalue = array(
                    ':grade' => 'F',
                    ':sub' => 'Biology',
